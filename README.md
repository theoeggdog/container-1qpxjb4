...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1qpxjb4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1qpxjb4.containers.anotherwebservice.com/
...
```
git clone git@github.com:theoeggdog/container-1qpxjb4.git
cd container-1qpxjb4
```
...
```
docker attach container-1qpxjb4
```
